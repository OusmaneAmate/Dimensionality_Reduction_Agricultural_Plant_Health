...
def NNModel(x, y):
    ...
    # Isomap 
    isom = Isomap(n_components=22)
    x_isom = isom.fit_transform(x_scaled)
...
for crop in DATASETS:
    ...
    print(f"📉 Isomap : {x.shape[1]} ➝ {x_iso.shape[1]} dimensions (fixées ) pour {crop}")
